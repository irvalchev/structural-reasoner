...
{
    class LessThan : BinaryRelation, IMetricRelation
    {
        public LessThan()
            : base(
                     MetricRelationNames.LessThan,
                     "A < B",
        ...
        public override List<TmsConstraint> GetTmsConstraints(ConfigurationConstraint constraint, Edge edge)
        {
            ...
            else
            {
                ...
                tmsConstraint.VariableTuple = new List<string>() { dVarB, dVarA, constraint.GetSatDVarName() };
        ...
        {
            // B-A is in [1, MAX]
            Interval interval = new Interval(1, StructuralRelationsManager.MetricDomain.MaxValue);
        ...
        public ConfigurationConstraint GetInverseConstraint(ConfigurationConstraint constraint)
        {
            ...
            inverseConstraint.AllowedRelations = new List<BinaryRelation>(){ 
                StructuralRelationsManager.GetRelation(RelationFamilyNames.MetricRelationsName, MetricRelationNames.GreaterThan)};
