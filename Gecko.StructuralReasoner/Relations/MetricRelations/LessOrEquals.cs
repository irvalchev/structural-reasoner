...
{
    class LessOrEquals : BinaryRelation, IMetricRelation
    {
        public LessOrEquals()
            : base(
                     MetricRelationNames.LessOrEquals,
                     "A <= B",
        ...
        public override List<TmsConstraint> GetTmsConstraints(ConfigurationConstraint constraint, Edge edge)
        {
            ...
            else
            {
                ...
                // Greater than or equals relation is used, but with switched places of relation parts
