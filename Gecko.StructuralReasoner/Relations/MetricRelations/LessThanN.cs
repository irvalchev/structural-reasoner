...
{
    class LessThanN : BinaryRelation, IMetricRelation
    {
        public LessThanN()
            : base(
                     MetricRelationNames.LessThanN,
                     "B < n",
        ...
        {
            // A - BeginOfTime is in [MIN, n - 1]
            MetricRelationPart relPartN = constraint.RelationParts[1] as MetricRelationPart;
            Interval interval = new Interval(StructuralRelationsManager.MetricDomain.MinValue , relPartN.GetIntValue() - 1);
