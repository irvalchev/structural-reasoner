...
{
    class GreaterOrEquals : BinaryRelation, IMetricRelation
    {
        public GreaterOrEquals()
            : base(
                     MetricRelationNames.GreaterOrEquals,
                     "A >= B",
        ...
        {
            // B-A is in [-MAX, 0]
            Interval interval = new Interval(-StructuralRelationsManager.MetricDomain.MaxValue, 0);
        ...
        public ConfigurationConstraint GetInverseConstraint(ConfigurationConstraint constraint)
        {
            ...
            inverseConstraint.AllowedRelations = new List<BinaryRelation>(){ 
                StructuralRelationsManager.GetRelation(RelationFamilyNames.MetricRelationsName, MetricRelationNames.LessOrEquals)};
