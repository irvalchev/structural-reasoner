...
{
    class NotEquals : BinaryRelation, IMetricRelation
    {
        public NotEquals()
            : base(
                     MetricRelationNames.NotEquals,
                     "A != B",
        ...
        public ConfigurationConstraint GetInverseConstraint(ConfigurationConstraint constraint)
        {
            ...
            inverseConstraint.AllowedRelations = new List<BinaryRelation>(){ 
                StructuralRelationsManager.GetRelation(RelationFamilyNames.MetricRelationsName, MetricRelationNames.NotEquals)};
