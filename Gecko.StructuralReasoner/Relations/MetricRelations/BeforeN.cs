...
{
    class BeforeN : BinaryRelation, IMetricRelation
    {
        public BeforeN()
            : base(
                     MetricRelationNames.BeforeN,
                     "A - n = B",
        ...
        public override List<TmsConstraint> GetTmsConstraints(ConfigurationConstraint constraint, Edge edge)
        {
            ...
            else
            {
                ...
                tmsConstraint.VariableTuple = new List<string>() { dVarB, dVarMetric, dVarA, constraint.GetSatDVarName() };
        ...
        public ConfigurationConstraint GetInverseConstraint(ConfigurationConstraint constraint)
        {
            ...
            inverseConstraint.AllowedRelations = new List<BinaryRelation>(){ 
                StructuralRelationsManager.GetRelation(RelationFamilyNames.MetricRelationsName, MetricRelationNames.AfterN)};
